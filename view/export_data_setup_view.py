...
class ExportDataSetupView():
    ...
    def __render_options(self):
        with dpg.group(tag="data_location_group"):
    ...
    def __bottom_window(self):
        with dpg.group(parent=self.window_name, horizontal=True):
            ...
            dpg.add_button(label=_("SAVE"), width=75, callback=self.__export_data, parent=self.window_name, indent=self.width_window - 100)
